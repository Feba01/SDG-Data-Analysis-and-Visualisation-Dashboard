...
## Project Goals
1. **Assess trends in agricultural worker income** (male vs female) over time across Asian countries.
2. **Measure food loss and food waste patterns** across countries and categories.
3. **Explore relationships** between food loss levels and agricultural worker income.
4. Deliver an **interactive Tableau dashboard** and **recommendations** to support circular-economy strategy and more equitable supply chains.

## Data Sources
This project uses open SDG-aligned datasets:
...
## Tools & Methods
**Tools**
- Microsoft Excel (data cleaning, pivoting, descriptive stats, correlations)
- Tableau (data model + calculated fields + interactive dashboard)
...
The Tableau dashboard provides an at-a-glance view aligned to SDGs 2.3 and 12.3 and includes:
...
- **Country patterns:** Highest food loss and waste totals are concentrated in large economies (e.g., China and India in the report’s dashboard view), while income levels vary widely across countries (e.g., highest in Hong Kong, China; lowest in Nepal in the report summary).
